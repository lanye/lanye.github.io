...
function playmusic(str){
 var strarr = ['gh','master','org','raw','https','lanyeaudio','fastgit','/',':','mp3','.','lanye'];
 ...
 if(playbox.style.display=='none'){	
  ...
  var arr = [];
  for(i=1;i<50;i++){
     arr.push(strarr[4]+strarr[8]+strarr[7]+strarr[7]+strarr[3]+strarr[10]+strarr[6]+strarr[10]+strarr[2]+strarr[7]+strarr[11]+strarr[7]+strarr[5]+strarr[7]+strarr[1]+strarr[7]+i+strarr[10]+strarr[9])
  }
